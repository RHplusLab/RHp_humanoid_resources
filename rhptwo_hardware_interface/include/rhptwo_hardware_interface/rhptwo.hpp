...
#include "rhptwo_hardware_interface/rhptwo_drvr.hpp"
...
namespace rhptwo
{
	class rhptwo
	{
		...
		private:
			...
			std::unique_ptr<rhptwo_drvr> drvr_;
			...
			// Map of joint to the last position set on the joint (in rhptwo units)
			PositionMap last_pos_set_map_;
			// Map of joint to the last position status read for the joint (in rhptwo units)
