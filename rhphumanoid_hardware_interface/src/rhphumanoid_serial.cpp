...
namespace rhphumanoid
{
	...
	bool rhphumanoid_serial::getJointVin(int id, uint16_t &vin)
	{
		return LobotSerialServoReadVin(fd_, id, vin);
	}
	...
	bool rhphumanoid_serial::loadAllJoints()
	{
		return LobotSerialServoLoad(fd_, 254);
	}
